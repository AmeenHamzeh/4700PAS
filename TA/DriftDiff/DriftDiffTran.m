...
elseif strcmp(Simulation,'GaussianTwoCarRC_modified') %line added for pt 2
    eval('SetGaussian2CarParasRCOnly_modified');      %line added for pt 2
elseif strcmp(Simulation,'GaussianTwoCarRC_exp') %line added for pt 3
    eval('SetGaussian2CarParasRCOnly_exp');      %line added for pt 3
