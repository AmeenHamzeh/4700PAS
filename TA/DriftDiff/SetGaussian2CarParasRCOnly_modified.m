...
start_value = 1e16; % Define the range
end_value = 20e16;

% Define the number of elements in the gradient
num_elements = nx; % adjust step size

% Generate the linear gradient
Nd = linspace(start_value, end_value, num_elements);
